...
:*
:*          Clase donde se maneja las físicas de los asteroides, la nave y el misil
:*
:*  Archivo     : VistaJuegoViewActivity.java
:*  Autor       : Sergio Alejandro Cháirez García     17130772
:*  Fecha       : 18/DIC/2020
:*  Compilador  : Android Studio
:*  Descripci�n : Ubica en la pantalla del dispositivo los gráficos a dibujar y actualiza sus
:*                 físicas dependiendo del gráfico que se necesitee instancia los listener de
:*                 la interacción del usuario con la pantalla.
:*
:*  Ultima modif:
...
public class VistaJuegoView extends View {
    ...
    public VistaJuegoView ( Context context, AttributeSet attrs ) {
        ...
        drawableNave = context.getResources().getDrawable(R.drawable.doomguy);
        drawableMisil = context.getResources().getDrawable(R.drawable.misil1);
        drawableAsteroide [0] = context.getResources().getDrawable(R.drawable.imp);
        drawableAsteroide [1] = context.getResources().getDrawable(R.drawable.imp2);
        drawableAsteroide [2] = context.getResources().getDrawable(R.drawable.imp3);
    ...
    private void activaMisil () {
        ...
        if ( mpAudioDisparo != null )
            mpAudioDisparo.start ();
    }
    ...
    public void setAudioDisparo ( MediaPlayer mpAudioDisparo ) {
        this.mpAudioDisparo = mpAudioDisparo;
    }

    public void setAudioHit ( MediaPlayer mpAudioHit ) {
        this.mpAudioHit = mpAudioHit;
    }

    public void setAudioImp ( MediaPlayer mpAudioImp ) {
        this.mpAudioImp = mpAudioImp;
    }
